...
try:
    gstorage_context = StorageContext.from_defaults(persist_dir='./storage_sgs')
    ...
    # save to disk
    kg_index.storage_context.persist(persist_dir="./storage_sgs")
    gstorage_context.persist(persist_dir="./storage_sgs")
